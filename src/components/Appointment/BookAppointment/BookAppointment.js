...
const BookAppointment = ({date}) => {
    ...
    return (
        <section className="container">
            <h2 className="text-center my-text" style={{padding: '100px 0px 100px '}}>Available Appointment On, {date.toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</h2>
